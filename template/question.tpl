...
Users        </a>
    ...
    <li>
        <a id="nav-jobs" href="https://stackoverflow.com/jobs?med=site-ui&amp;ref=jobs-tab" class=" js-gps-track nav-links--link" data-gps-track="top_nav.click({is_current:false, location:2, destination:6})">
Jobs        </a>
    </li>
                                                    </ol>
                    </li>
...
<div itemprop="mainEntity" itemscope="" itemtype="http://schema.org/Question">
    ...
    <div class="inner-content clearfix">
            ...
            <div id="question-header" class="grid">
                    <h1 itemprop="name" class="grid--cell fs-headline1 fl1 ow-break-word"><a href="https://stackoverflow.com/questions/513832/how-do-i-compare-strings-in-java" class="question-hyperlink">{{.Title}}</a></h1>

            
<div class="pl8 aside-cta grid--cell" role="navigation" aria-label="ask new question">
        <a href="https://stackoverflow.com/questions/ask" class="d-inline-flex ai-center ws-nowrap s-btn s-btn__primary">
            Ask Question
        </a>
</div>
...
<div class="question" data-questionid="513832" id="question">

        <input type="hidden" id="513832-only-allow-inform-moderator-flagging" value="true">
...
<div class="js-voting-container grid fd-column ai-stretch gs4 fc-black-200" data-post-id="513832">
        <button class="js-vote-up-btn grid--cell s-btn s-btn__unset c-pointer" title="This question shows research effort; it is useful and clear" aria-pressed="false" aria-label="up vote" data-selected-classes="fc-theme-primary"><svg aria-hidden="true" class="svg-icon m0 iconArrowUpLg" width="36" height="36" viewBox="0 0 36 36"><path d="M2 26h32L18 10z"></path></svg></button>
        <div class="js-vote-count grid--cell fc-black-500 fs-title grid fd-column ai-center" itemprop="upvoteCount" data-value="{{.Score}}">{{.Score}}</div>
        ...
        <button class="js-favorite-btn s-btn s-btn__unset c-pointer py8" aria-pressed="false" aria-label="favorite (948)" data-selected-classes="fc-yellow-600" title="Click to mark as favorite question (click again to undo)">
            ...
            <div class="js-favorite-count mt8" data-value="948">948</div>
        </button>
    ...
    <div class="post-text" itemprop="text">
        ...
        <div class="post-taglist grid gs4 gsy fd-column">
            <div class="grid ps-relative d-block">
                <a href="https://stackoverflow.com/questions/tagged/java" class="post-tag js-gps-track" title="show questions tagged '{{.Tags}}'" rel="tag">{{.Tags}}</a> <a href="https://stackoverflow.com/questions/tagged/string" class="post-tag js-gps-track" title="show questions tagged 'string'" rel="tag">string</a> <a href="https://stackoverflow.com/questions/tagged/equality" class="post-tag js-gps-track" title="show questions tagged 'equality'" rel="tag">equality</a> 
            </div>
        </div>
...
<div class="post-menu"><a href="https://stackoverflow.com/q/513832/7623252" title="short permalink to this question" class="short-link" itemprop="url" id="link-post-513832">share</a><span class="lsep">|</span><a href="#" class="js-error-click" title="revise and improve this post" data-error-message="Post is locked.">edit</a></div>
            </div>

                <div class="post-signature grid--cell">
<div class="user-info ">
    <div class="user-action-time">
        <a href="https://stackoverflow.com/posts/513832/revisions" title="show all edits to this post">edited <span title="2013-01-23 13:36:07Z" class="relativetime">Jan 23 '13 at 13:36</span></a>
    </div>
...
<div class="user-info">
    ...
    <div class="user-details">
        <a id="history-513832" href="https://stackoverflow.com/posts/513832/revisions" title="show revision history for this post">
        Nathan H
        </a>
    </div>
</div>
    ...
    <div class="post-layout--right">
	    <div id="comments-513832" class="comments js-comments-container " data-post-id="513832">
            <ul class="comments-list js-comments-list" data-remaining-comments-count="0" data-canpost="false" data-cansee="false" data-comments-unavailable="true" data-addlink-disabled="true">
                ...
                {{ range .Comments }}
    <li id="comment-29455790" class="comment js-comment " data-comment-id="29455790">
        ...
        <div class="comment-text js-comment-text-and-form">
            <div class="comment-body js-comment-edit-hide">
                ...
                <span class="comment-copy">{{.Text}}</span>
                
                    –&nbsp;<a href="https://stackoverflow.com/users/{{.UserID}}/nageswaran" title="2,819 reputation" class="comment-user"> username </a>
                <span class="comment-date" dir="ltr"><a class="comment-link" href="#comment29455790_513832"><span title="{{.CreationDate}}" class="relativetime-clean">{{.CreationDate}}</span></a></span>
                                                            </div>
        </div>
    </li>
    {{ end }}
        ...
        <div id="comments-link-513832" data-rep="50" data-reg="true">

                <a class="js-add-link comments-link disabled-link " title="Use comments to ask for more information or suggest improvements. Avoid answering questions in comments.">comments disabled on deleted / locked posts / reviews</a><span class="js-link-separator dno">&nbsp;|&nbsp;</span>
...
<div id="dfp-isb" class="everyonelovesstackoverflow everyoneloves__inline-sidebar" style="min-height: auto; height: auto; display: none;"></div>
            <div id="answers">

                <a name="tab-top"></a>
                <div id="answers-header">
                    <div class="subheader answers-subheader">
                        <h2 data-answercount="23">
                                23 Answers
...
<div id="tabs">
        <a href="https://stackoverflow.com/questions/513832/how-do-i-compare-strings-in-java?answertab=active#tab-top" data-nav-xhref="" title="Answers with the latest activity first" data-value="active" data-shortcut="A">
            active</a>
        <a href="https://stackoverflow.com/questions/513832/how-do-i-compare-strings-in-java?answertab=oldest#tab-top" data-nav-xhref="" title="Answers in the order they were provided" data-value="oldest" data-shortcut="O">
            oldest</a>
        <a class="youarehere is-selected " href="https://stackoverflow.com/questions/513832/how-do-i-compare-strings-in-java?answertab=votes#tab-top" data-nav-xhref="" title="Answers with the highest score first" data-value="votes" data-shortcut="V">
            votes</a>
    </div>
...
<a name="{{.ID}}"></a>
<div id="answer-{{.ID}}" class="answer accepted-answer" data-answerid="{{.ID}}" itemprop="acceptedAnswer" itemscope="" itemtype="http://schema.org/Answer">
    <div class="post-layout">
            <div class="votecell post-layout--left">
                

<div class="js-voting-container grid fd-column ai-stretch gs4 fc-black-200" data-post-id="{{.ID}}">
        ...
        <button class="js-vote-down-btn grid--cell s-btn s-btn__unset c-pointer" title="This answer is not useful" aria-pressed="false" aria-label="down vote" data-selected-classes="fc-theme-primary"><svg aria-hidden="true" class="svg-icon m0 iconArrowDownLg" width="36" height="36" viewBox="0 0 36 36"><path d="M2 10h32L18 26z"></path></svg></button>
                ...
                <div class="js-accepted-answer-indicator grid--item fc-green-500 ta-center p4" title="loading when this answer was accepted..." tabindex="0" role="note" aria-label="accepted"><svg aria-hidden="true" class="svg-icon iconCheckmarkLg" width="36" height="36" viewBox="0 0 36 36"><path d="M6 14l8 8L30 6v8L14 30l-8-8z"></path></svg></div>
...
<div class="answercell post-layout--right">
    ...
    <div class="grid mb0 fw-wrap ai-start jc-end gs8 gsy">
        <time itemprop="dateCreated" datetime="2009-02-04T23:19:49"></time>
    <div class="grid--cell mr16" style="flex: 1 1 100px;">
<div class="post-menu"><a href="https://stackoverflow.com/a/513839/7623252" title="short permalink to this answer" class="short-link" itemprop="url" id="link-post-513839">share</a><span class="lsep">|</span><a href="#" class="js-error-click" title="revise and improve this post" data-error-message="Question is locked.">edit</a></div>                    </div>
    <div class="post-signature grid--cell fl0">
<div class="user-info ">
    <div class="user-action-time">
        <a href="https://stackoverflow.com/posts/513839/revisions" title="show all edits to this post">edited <span title="2018-11-09 18:31:21Z" class="relativetime">Nov 9 '18 at 18:31</span></a>
    </div>
    <div class="user-gravatar32">
...
<div class="user-info">
    ...
    <div class="user-details">
        <a id="history-513839" href="https://stackoverflow.com/posts/513839/revisions" title="show revision history for this post">
        40 revs, 24 users 42%<br></a><a href="https://stackoverflow.com/users/2603">Aaron Maenpaa</a>
    ...
    <div class="post-layout--right">
	    <div id="comments-513839" class="comments js-comments-container " data-post-id="513839">
            <ul class="comments-list js-comments-list" data-remaining-comments-count="45" data-canpost="false" data-cansee="true" data-comments-unavailable="false" data-addlink-disabled="true">
            ...
            ***************************/}}
            {{range .Comments}}
                ...
                <li id="comment-329044" class="comment js-comment " data-comment-id="329044">
                    <div class="js-comment-actions comment-actions">
                        <div class="comment-score js-comment-edit-hide">
                            <span title="number of 'useful comment' votes received" class="supernova">343</span>
                        </div>
                    </div>
                    <div class="comment-text js-comment-text-and-form">
                        <div class="comment-body js-comment-edit-hide">
                            <span class="comment-copy">{{.Text}}</spam> –&nbsp;<a href="https://stackoverflow.com/users/2238/henrik-paul" title="43,659 reputation" class="comment-user">Henrik Paul</a>
                            <span class="comment-date" dir="ltr"><a class="comment-link" href="#comment329044_513839"><span title="{{.CreationDate}}" class="relativetime-clean">{{.CreationDate}}</span></a></span>
                        </div>
                    </div>
                </li>
        ...
        <div id="comments-link-513839" data-rep="50" data-reg="true">
            ...
            <a class="js-show-link comments-link " title="expand to show all comments on this post" href="#" onclick="">show <b>45</b> more comments</a>
        </div>         
    </div>    </div>
...
<div id="dfp-mlb" class="everyonelovesstackoverflow everyoneloves__mid-leaderboard" style="display: none;"></div>
...
Not the answer you're looking for?                            Browse other questions tagged <a href="https://stackoverflow.com/questions/tagged/java" class="post-tag" title="show questions tagged '{{.Tags}}'" rel="tag">{{.Tags}}</a> <a href="https://stackoverflow.com/questions/tagged/string" class="post-tag" title="show questions tagged 'string'" rel="tag">string</a> <a href="https://stackoverflow.com/questions/tagged/equality" class="post-tag" title="show questions tagged 'equality'" rel="tag">equality</a>  or <a href="https://stackoverflow.com/questions/ask">ask your own question</a>.                        </h2>
            </div>
        </div>
...
<div class="module newuser newuser-greeting" id="newuser-box" style="display:none;">
    ...
    <div>
        ...
        <p class="ar">
                <a href="https://stackoverflow.com/tour?mnu=1">about »</a>&nbsp;&nbsp;&nbsp;
            <a href="https://stackoverflow.com/help?mnu=1">help »</a>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding-left: 10px">
                        <p class="label-key" title="2009-02-04 23:17:07Z">
                            <b>
                                <time itemprop="dateCreated" datetime="{{.CreationDate}}">{{.CreationDate}}</time>
                            </b>
                        </p>
                    </td>
                </tr>
                <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px">
                            <p class="label-key"><b><a href="https://stackoverflow.com/questions/513832/how-do-i-compare-strings-in-java?lastactivity" class="lastactivity-link" title="{{.LastActivityDate}}">{{.LastActivityDate}}</a></b></p>
                        </td>
                    </tr>
            </tbody>
        </table>
...
<div class="spacer">
	<a href="https://stackoverflow.com/q/767372?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted large">503</div>
	</a>
	<a href="https://stackoverflow.com/questions/767372/string-equals-versus?noredirect=1&amp;lq=1" class="question-hyperlink">String.equals versus ==</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/8484668?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted default">45</div>
	</a>
	<a href="https://stackoverflow.com/questions/8484668/java-does-not-equal-not-working?noredirect=1&amp;lq=1" class="question-hyperlink">Java Does Not Equal (!=) Not Working?</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/995918?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes  default">44</div>
	</a>
	<a href="https://stackoverflow.com/questions/995918/java-comparison-with-of-two-strings-is-false?noredirect=1&amp;lq=1" class="question-hyperlink">Java comparison with == of two strings is false?</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/658953?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes  default">40</div>
	</a>
	<a href="https://stackoverflow.com/questions/658953/if-statement-with-string-comparison-fails?noredirect=1&amp;lq=1" class="question-hyperlink">If statement with String comparison fails</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/5307074?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted default">38</div>
	</a>
	<a href="https://stackoverflow.com/questions/5307074/how-to-compare-two-strings-are-equal-in-value-what-is-the-best-method?noredirect=1&amp;lq=1" class="question-hyperlink">How to compare two strings are equal in value, what is the best method?</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/2772763?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted default">31</div>
	</a>
	<a href="https://stackoverflow.com/questions/2772763/why-equals-method-when-we-have-operator?noredirect=1&amp;lq=1" class="question-hyperlink">why equals() method when we have == operator?</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/7375427?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes  default">19</div>
	</a>
	<a href="https://stackoverflow.com/questions/7375427/comparing-two-identical-strings-with-returns-false?noredirect=1&amp;lq=1" class="question-hyperlink">Comparing two identical strings with == returns false</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/6819604?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes  default">16</div>
	</a>
	<a href="https://stackoverflow.com/questions/6819604/comparison-of-two-strings-doesnt-work-in-android?noredirect=1&amp;lq=1" class="question-hyperlink">comparison of two Strings doesn't work in android</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/14338965?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted default">12</div>
	</a>
	<a href="https://stackoverflow.com/questions/14338965/why-is-f-alse-not-false?noredirect=1&amp;lq=1" class="question-hyperlink">Why is “F” + “alse” not == “False”?</a>
</div>
<div class="spacer">
	<a href="https://stackoverflow.com/q/3281448?lq=1" title="Vote score (upvotes - downvotes)">
		<div class="answer-votes answered-accepted default">5</div>
	</a>
	<a href="https://stackoverflow.com/questions/3281448/strings-in-java-equals-vs?noredirect=1&amp;lq=1" class="question-hyperlink">Strings in Java : equals vs ==</a>
</div>					<div class="spacer more">
				<a href="https://stackoverflow.com/questions/linked/513832?lq=1">see more linked questions…</a>
			</div>
	</div>
</div>
                ...
                <div class="module sidebar-related">
                    ...
                    <div class="related js-gps-related-questions" data-tracker="rq=1">
                        <div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/7074?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">5903</div></a><a href="https://stackoverflow.com/questions/7074/what-is-the-difference-between-string-and-string-in-c?rq=1" class="question-hyperlink">What is the difference between String and string in C#?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/40480?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes extra-large">5907</div></a><a href="https://stackoverflow.com/questions/40480/is-java-pass-by-reference-or-pass-by-value?rq=1" class="question-hyperlink">Is Java “pass-by-reference” or “pass-by-value”?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/309424?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">3637</div></a><a href="https://stackoverflow.com/questions/309424/how-do-i-read-convert-an-inputstream-into-a-string-in-java?rq=1" class="question-hyperlink">How do I read / convert an InputStream into a String in Java?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/1144783?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">3713</div></a><a href="https://stackoverflow.com/questions/1144783/how-to-replace-all-occurrences-of-a-string-in-javascript?rq=1" class="question-hyperlink">How to replace all occurrences of a string in JavaScript</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/1750435?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">1545</div></a><a href="https://stackoverflow.com/questions/1750435/comparing-java-enum-members-or-equals?rq=1" class="question-hyperlink">Comparing Java enum members: == or equals()?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/1789945?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">7434</div></a><a href="https://stackoverflow.com/questions/1789945/how-to-check-whether-a-string-contains-a-substring-in-javascript?rq=1" class="question-hyperlink">How to check whether a string contains a substring in JavaScript?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/3437059?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">3567</div></a><a href="https://stackoverflow.com/questions/3437059/does-python-have-a-string-contains-substring-method?rq=1" class="question-hyperlink">Does Python have a string 'contains' substring method?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/5585779?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">2775</div></a><a href="https://stackoverflow.com/questions/5585779/how-do-i-convert-a-string-to-an-int-in-java?rq=1" class="question-hyperlink">How do I convert a String to an int in Java?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/6841333?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">6398</div></a><a href="https://stackoverflow.com/questions/6841333/why-is-subtracting-these-two-times-in-1927-giving-a-strange-result?rq=1" class="question-hyperlink">Why is subtracting these two times (in 1927) giving a strange result?</a></div><div class="spacer js-gps-track"><a href="https://stackoverflow.com/q/8881291?rq=1" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">3141</div></a><a href="https://stackoverflow.com/questions/8881291/why-is-char-preferred-over-string-for-passwords?rq=1" class="question-hyperlink">Why is char[] preferred over String for passwords?</a></div>
                    </div>
                </div>
        ...
        <div class="site-footer--container">
            ...
            <nav class="site-footer--nav">
                ...
                <div class="site-footer--col site-footer--categories-nav site-footer--col__visible">
                    <a href="#" class="site-footer--back js-footer-back"><svg aria-hidden="true" class="svg-icon iconArrowLeftAlt" width="18" height="18" viewBox="0 0 18 18"><path d="M10.58 16L12 14.59 6.4 9 12 3.41 10.57 2l-7 7z"></path></svg></a>
                    <div>
...
site design / logo © 2019 Stack Exchange Inc; user contributions licensed under <a href="https://creativecommons.org/licenses/by-sa/3.0/" rel="license">cc by-sa 3.0</a>
                    ...
                    <span id="svnrev">rev&nbsp;2019.4.26.33469</span>
                </p>
            </div>
        </div>
...
<script>
            ...
            StackExchange.ready(function () {
                ...
                StackExchange.ga.init({
                    ...
                    StackExchange.ga.setDimension('dimension1', '10334661');


                    StackExchange.ga.setDimension('dimension2', '|java|string|equality|');
